                                ...
                                <div class="tp-shop-widget-content">
                                    <div class="tp-shop-widget-product">
                                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                                            <div class="tp-shop-widget-product-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{asset('assets/client/assets/img/product/shop/sm/shop-sm-1.jpg')}}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                                            <div class="tp-shop-widget-product-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{asset('assets/client/assets/img/product/shop/sm/shop-sm-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="tp-shop-widget-product-content">
                                                <div
                                        ...
                                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                                            <div class="tp-shop-widget-product-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{asset('assets/client/assets/img/product/shop/sm/shop-sm-3.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="tp-shop-widget-product-content">
                                                <div
                                        ...
                                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                                            <div class="tp-shop-widget-product-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{asset('assets/client/assets/img/product/shop/sm/shop-sm-4.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="tp-shop-widget-product-content">
                                                <div
                                ...
                                <div class="tp-shop-widget-content ">
                                    <div
                                        ...
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('assets/client/assets/img/product/shop/brand/logo_01.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('assets/client/assets/img/product/shop/brand/logo_02.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('assets/client/assets/img/product/shop/brand/logo_03.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('assets/client/assets/img/product/shop/brand/logo_04.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('assets/client/assets/img/product/shop/brand/logo_05.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('assets/client/assets/img/product/shop/brand/logo_06.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('assets/client/assets/img/product/shop/brand/logo_07.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('assets/client/assets/img/product/shop/brand/logo_08.png')}}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row infinite-container">
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-1.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-2.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-3.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-4.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-5.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-6.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-7.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-8.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-9.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-10.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-11.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                            ...
                                            <div class="col-xl-4 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/product/2/prodcut-12.jpg')}}" alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('assets/client/assets/img/product/list/product-list-1.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('assets/client/assets/img/product/list/product-list-2.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('assets/client/assets/img/product/list/product-list-3.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('assets/client/assets/img/product/list/product-list-4.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('assets/client/assets/img/product/list/product-list-5.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('assets/client/assets/img/product/list/product-list-6.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('assets/client/assets/img/product/list/product-list-7.jpg')}}"
                                                                    alt="">
                                                            </a>
                            ...
                            <nav>
                                <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                    ...
                                    <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3"
                                        ...
                                        <img src="{{asset('assets/client/assets/img/product/details/nav/product-details-nav-3.jpg')}}" alt="">
                                    </button>
