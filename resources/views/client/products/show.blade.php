                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                ...
                                <div
                                    ...
                                    <img src="{{asset('assets/client/assets/img/product/icons/payment-option.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/client/assets/img/product/related/product-related-1.jpg')}}"
                                                    alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/client/assets/img/product/related/product-related-2.jpg')}}"
                                                    alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/client/assets/img/product/related/product-related-3.jpg')}}"
                                                    alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/client/assets/img/product/related/product-related-4.jpg')}}"
                                                    alt="">
                                            </a>
