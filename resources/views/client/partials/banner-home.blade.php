               ...
               <div class="row">
                  <div class="col-xl-8 col-lg-7">
                     <div class="tp-banner-item tp-banner-height p-relative mb-30 z-index-1 fix">
                        <div class="tp-banner-thumb include-bg transition-3" data-background="{{asset('assets/client/assets/img/product/banner/product-banner-1.jpg')}}"></div>
                  ...
                  <div class="col-xl-4 col-lg-5">
                     <div class="tp-banner-item tp-banner-item-sm tp-banner-height p-relative mb-30 z-index-1 fix">
                        <div class="tp-banner-thumb include-bg transition-3" data-background="{{asset('assets/client/assets/img/product/banner/product-banner-2.jpg')}}"></div>
                        <div class="tp-banner-content">
                           <h3 class="tp-banner-title">
