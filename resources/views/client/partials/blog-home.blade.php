                    ...
                    <div class="tp-blog-main-slider-active swiper-container">
                        <div class="swiper-wrapper">
                            <div class="tp-blog-item mb-30 swiper-slide">
                                <div class="tp-blog-thumb p-relative fix">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('assets/client/assets/img/blog/blog-1.jpg') }}"
                                            alt="">
                                    </a>
                            ...
                            <div class="tp-blog-item mb-30 swiper-slide">
                                <div class="tp-blog-thumb p-relative fix">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('assets/client/assets/img/blog/blog-2.jpg') }}"
                                            alt="">
                                    </a>
                                    <div class="tp-blog-meta tp-blog-meta-date">
                            ...
                            <div class="tp-blog-item mb-30 swiper-slide">
                                <div class="tp-blog-thumb p-relative fix">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('assets/client/assets/img/blog/blog-3.jpg') }}"
                                            alt="">
                                    </a>
                                    <div class="tp-blog-meta tp-blog-meta-date">
