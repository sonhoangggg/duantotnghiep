                                            ...
                                            <nav>
                                                <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb"
                                                    ...
                                                    <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab"
                                                        ...
                                                        <img src="{{ asset('assets/client/assets/img/product/details/nav/product-details-nav-1.jpg') }}"
                                                            alt="">
                                                    </button>
                                                    <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab"
                                                        ...
                                                        <img src="{{ asset('assets/client/assets/img/product/details/nav/product-details-nav-2.jpg') }}"
                                                            alt="">
                                                    </button>
                                                    <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab"
                                                        ...
                                                        <img src="{{ asset('assets/client/assets/img/product/details/nav/product-details-nav-3.jpg') }}"
                                                            alt="">
                                                    </button>
                                                    <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab"
                                                        ...
                                                        <img src="{{ asset('assets/client/assets/img/product/details/nav/product-details-nav-4.jpg') }}"
                                                            alt="">
                                                    </button>
                                                    <button class="nav-link" id="nav-5-tab" data-bs-toggle="tab"
                                                        ...
                                                        <img src="{{ asset('assets/client/assets/img/product/details/nav/product-details-nav-5.jpg') }}"
                                                            alt="">
                                                    </button>
                                                </div>
                                            </nav>
                                            <div class="tab-content m-img" id="productDetailsNavContent">
                                                <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                                    ...
                                                    <div class="tp-product-details-nav-main-thumb">
                                                        <img src="{{ asset('assets/client/assets/img/product/details/main/product-details-main-1.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="nav-2" role="tabpanel"
                                                    ...
                                                    <div class="tp-product-details-nav-main-thumb">
                                                        <img src="{{ asset('assets/client/assets/img/product/details/main/product-details-main-2.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="nav-3" role="tabpanel"
                                                    ...
                                                    <div class="tp-product-details-nav-main-thumb">
                                                        <img src="{{ asset('assets/client/assets/img/product/details/main/product-details-main-3.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="nav-4" role="tabpanel"
                                                    ...
                                                    <div class="tp-product-details-nav-main-thumb">
                                                        <img src="{{ asset('assets/client/assets/img/product/details/main/product-details-main-4.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="nav-5" role="tabpanel"
                                                    ...
                                                    <div class="tp-product-details-nav-main-thumb">
                                                        <img src="{{ asset('assets/client/assets/img/product/details/main/product-details-main-5.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-5 col-lg-6">
                                        <div class="tp-product-details-wrapper">
                                            <div class="tp-product-details-category">
                                                <span>
                                                    @foreach ($sanPham->danhMucs as $danhMuc )
                                                        {{$danhMuc->ten}} |
                                                    @endforeach
                                                </span>
                                            </div>
                                            <h3 class="tp-product-details-title">{{$sanPham->ten}}</h3>
                                                        ...
                                                        <div class="tp-product-quantity mb-15 mr-15">
                                                            <span class="tp-cart-minus">
                                                                <svg width="11" height="2" viewBox="0 0 11 2"
                                                                    ...
                                                                    <path d="M1 1H10" stroke="currentColor"
                                            ...
                                            <div
                                                ...
                                                <img src="{{ asset('assets/client/assets/img/product/icons/payment-option.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="tp-product-details-tab-nav tp-tab">
                                            <nav>
                                                <div class="nav nav-tabs justify-content-center p-relative tp-product-tab"
                                                    ...
                                                    <button class="nav-link active" id="nav-addInfo-tab"
                                                    ...
                                                    <span id="productTabMarker"
                                                        class="tp-product-details-tab-line"></span>
                                                </div>
                                            </nav>
                                                            ...
                                                            <div class="col-xl-10">
                                                                <div class="tp-product-details-desc-item pb-105">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div
                                                                                class="tp-product-details-desc-content pt-25">
                                                                                <span>Galaxy A8 tablet</span>
                                                                                <h3 class="tp-product-details-desc-title">
                                                                                    Your world
                                                                                    at a glance</h3>
                                                                                <p>With a slim design, a vibrant
                                                                                    entertainment
                                                                                    system, and <br> outstanding
                                                                                    performance, the
                                                                                    new Galaxy Tab A7 is a stylish new <br>
                                                                                    companion for your life.Dive head-first
                                                                                    into the
                                                                                    things you love, <br> and easily share
                                                                                    your
                                                                                    favorite moments. Learn, explore,
                                                                                    connect <br>
                                                                                    and be inspired.</p>
                                                                            </div>
                                                                            <div class="tp-product-details-desc-content">
                                                                                ...
                                                                                <p>S Pen is a bundle of writing instruments
                                                                                    in one.
                                                                                    Its natural grip, <br> low latency and
                                                                                    impressive pressure sensitivity will
                                                                                    make it
                                                                                    your go-to for everything from drawing
                                                                                    to
                                                                                    editing documents. And S Pen won't get
                                                                                    misplaced
                                                                                    thanks.</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <div class="tp-product-details-desc-thumb">
                                                                                <img src="{{ asset('assets/client/assets/img/product/details/desc/product-details-desc-1.jpg') }}"
                                                                                    alt="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="tp-product-details-desc-item  pb-75">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-7">
                                                                            <div class="tp-product-details-desc-thumb">
                                                                                <img src="{{ asset('assets/client/assets/img/product/details/desc/product-details-desc-2.jpg') }}"
                                                                                    alt="">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-lg-5 order-first order-lg-last">
                                                                            <div
                                                                                ...
                                                                                <p>Wrap your tablet in a sleek case that's
                                                                                    as
                                                                                    stylish as it is convenient. Galaxy Tab
                                                                                    S6 Lite
                                                                                    Book Cover folds around and clings
                                                                                    magnetically,
                                                                                    so you can easily gear up as you're
                                                                                    headed out
                                                                                    the door. There's even a compartment for
                                                                                    S pen,
                                                                                    so you can be sure it doesn't get left
                                                                                    behind.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-xl-12">
                                                                            <div
                                                                                ...
                                                                                <img src="{{ asset('assets/client/assets/img/product/details/desc/product-details-desc-3.jpg') }}"
                                                                                    alt="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>Exynos 9611, Octa Core (4x2.3GHz + 4x1.7GHz)
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Wireless Type</td>
                                                                        ...
                                                                        <tr>
                                                                            <td>Batteries</td>
                                                                            <td>1 Lithium Polymer batteries required.
                                                                                (included)
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                    ...
                                                                    <div class="tp-product-details-review-list pr-110">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <a href="#">
                                                                                    <img src="{{ asset('assets/client/assets/img/users/user-3.jpg') }}"
                                                                                        alt="">
                                                                                </a>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <p>Designed very similarly to the nearly
                                                                                        double
                                                                                        priced Galaxy tab S6, with the only
                                                                                        removal
                                                                                        being.</p>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                class="tp-product-details-review-avater-thumb">
                                                                                <a href="#">
                                                                                    <img src="{{ asset('assets/client/assets/img/users/user-2.jpg') }}"
                                                                                        alt="">
                                                                                </a>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="tp-product-details-review-avater-comment">
                                                                                    <p>This review is for the Samsung Tab S6
                                                                                        Lite,
                                                                                        64gb wifi in blue. purchased this
                                                                                        product
                                                                                        performed.</p>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="tp-product-details-review-form">
                                                                    ...
                                                                    <form action="#">
                                                                        ...
                                                                        <div
                                                                            class="tp-product-details-review-input-wrapper">
                                                                            <div
                                                                        ...
                                                                        <div
                                                                            class="tp-product-details-review-suggetions mb-20">
                                                                            <div class="tp-product-details-review-remeber">
                                                                                <input id="remeber" type="checkbox">
                                                                                <label for="remeber">Save my name, email,
                                                                                    and
...
@push('css')
    <link rel="stylesheet" href="{{ asset('assets/client/assets/css/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/client/assets/css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/client/assets/css/swiper-bundle.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/client/assets/css/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/client/assets/css/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/client/assets/css/font-awesome-pro.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/client/assets/css/flaticon_shofy.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/client/assets/css/spacing.css') }}">
...
@push('js')
        <script src="{{ asset('assets/client/assets/js/vendor/jquery.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/vendor/waypoints.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/bootstrap-bundle.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/meanmenu.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/swiper-bundle.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/slick.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/range-slider.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/magnific-popup.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/nice-select.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/purecounter.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/countdown.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/wow.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/isotope-pkgd.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/imagesloaded-pkgd.js') }}"></script>
    <script src="{{ asset('assets/client/assets/js/ajax-form.js') }}"></script>
