                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                <div class="tp-product-details-category">
                                    @foreach ($san_pham->danhMucs as $dm_sp)
                                        <span> | {{ $dm_sp->ten }} </span>
                                    @endforeach
                                </div>
                                <h3 class="tp-product-details-title">{{ $san_pham->ten }}</h3>

                                <!-- inventory details -->
                                <div class="tp-product-details-inventory d-flex align-items-center mb-10">
                                    <div class="tp-product-details-stock mb-10">
                                        <span>
                                            @if ($san_pham->loai === 'don')
                                                {{ $san_pham->so_luong }}
                                            @else
                                                {{ $san_pham->bienThes->sum('so_luong') }}
                                            @endif
                                        </span>
                                    </div>
                                ...
                                <div class="tp-product-details-price-wrapper mb-20">
                                    @if ($gia_ban == null)
                                        <span class="tp-product-details-price new-price">{{ $gia_goc }}</span>
                                    @else
                                        <span class="tp-product-details-price old-price">{{ $gia_goc }} </span>
                                        <span class="tp-product-details-price new-price">{{ $gia_ban }}</span>
                                    @endif
                                </div>
                                ...
                                <div class="tp-product-details-variation">
                                    ...
                                    @if (isset($gia_tri_thuoc_tinh))
                                        @foreach ($gia_tri_thuoc_tinh as $tt)
                                            <div class="mb-3">
                                                <strong>{{ $tt['ten'] }}</strong>

                                                @if ($tt['kieu'] === 'mau')
                                                    {{-- hiển thị ô màu --}}
                                                    <div class="tp-product-details-variation-list">
                                                        @foreach ($tt['gia_tri'] as $gt)
                                                            <button type="button" class="color tp-color-variation-btn">
                                                                <span data-bg-color="{{ $gt['gia_tri'] }}"></span>
                                                                <span
                                                                    class="tp-color-variation-tootltip">{{ $gt['ten'] }}</span>
                                                            </button>
                                                        @endforeach
                                                    </div>
                                                @elseif ($tt['kieu'] === 'chuoi')
                                                    <div class="tp-product-details-variation-item">
                                                        <div class="tp-product-details-variation-list">
                                                            @foreach ($tt['gia_tri'] as $gt)
                                                                <button style="min-width: 80px"     type="button" class=" tp-size-variation-btn">
                                                                    <span>{{ $gt['ten'] }}</span>
                                                                </button>
                                                            @endforeach
                                                        </div>
                                                ...
                                                @elseif ($tt['kieu'] === 'anh')
                                                    {{-- hiển thị ảnh --}}
                                                    <div class="tp-product-details-variation-list " width="60px">
                                                        @foreach ($tt['gia_tri'] as $gt)
                                                            <button type="button" class="tp-size-variation-btn">
                                                                <img src="{{ Storage::url($gt['gia_tri']) }}"
                                                                    class="w-100" alt="">
                                                                <span
                                                                    class="tp-color-variation-tootltip">{{ $gt['ten'] }}</span>
                                                            </button>
                                ...
                                <div class="tp-product-details-query">
                                    ...
                                    <div class="tp-product-details-query-item d-flex align-items-center">
                                        <span>Category: </span>
                                        @foreach ($san_pham->danhMucs as $dm )
                                            <p> | {{$dm->ten}}</p>
                                        @endforeach
                                    </div>
                                        ...
                                        <div class="tp-product-details-additional-info ">
                                            <div class="row justify-content-center">
                                                <div class="col-xl-10">
                                                    <table>
                                                        <tbody>
                                                            {{-- @dd($san_pham->thongSos) --}}
                                                            @if ($san_pham->thongSos)
                                                                @foreach ($san_pham->thongSos as $thong_so)
                                                                    <tr>
                                                                        <td>{{ $thong_so->ten }}</td>
                                                                        <td>{{ $thong_so->pivot->gia_tri }}
                                                                            {{ $thong_so->don_vi }} </td>
                                                                    </tr>
                                                                @endforeach
                                                            @endif
                                                                ...
                                                                <div class="tp-product-details-review-input-box">
                                                                    <div class="tp-product-details-review-input">
                                                                        <input name="name" id="name"
                                                                            type="text" placeholder="Shahnewaz Sakil">
                                                                    </div>
                                                                    <div class="tp-product-details-review-input-title">
                                                                ...
                                                                <div class="tp-product-details-review-input-box">
                                                                    <div class="tp-product-details-review-input">
                                                                        <input name="email" id="email"
                                                                            type="email" placeholder="shofy@mail.com">
                                                                    </div>
                                                                    <div class="tp-product-details-review-input-title">
