...
@section('content')
    <div class="container-fluid">
        ...
        <div>
            <form action="{{ route('admin.san-pham.cap-nhap', $san_pham->slug) }}" method="post"
                ...
                <div class="row">
                    <div class="col-8">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-12">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('ten_sp', $san_pham->ten) }}" name="ten_sp" id="">
                                        @error('ten_sp')
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <input type="text" value="{{ old('slug_sp', $san_pham->slug) }}"
                                            class="form-control" name="slug_sp" id="">
                                        @error('slug_sp')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="text" value="{{ old('sku_sp', $san_pham->sku) }}"
                                            class="form-control" name="sku_sp" id="">
                                        @error('sku_sp')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="mb-3 col-6">
                                            ...
                                            <input type="text" value="{{ old('so_luong', $san_pham->so_luong) }}"
                                                class="form-control" name="so_luong" id="">
                                            @error('so_luong')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('gia_tt', $san_pham->gia_goc) }}" name="gia_tt"
                                                id="">
                                            @error('gia_tt')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="mb-3 col-6">
                                            ...
                                            <input type="text" value="{{ old('gia_km', $san_pham->gia_ban) }}"
                                                class="form-control" name="gia_km" id="">
                                            @error('gia_km')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <textarea name="mo_ta_ngan" id="moTaNgan">{{ old('mo_ta_ngan', $san_pham->mo_ta_ngan) }}</textarea>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header py-2">
                            ...
                            <div class="card-body">
                                <textarea name="mo_ta" id="mytextarea">{{ old('mo_ta', $san_pham->mo_ta_chi_tiet) }}</textarea>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header py-2">
                            ...
                            <div class="card-body row">
                                <div class="mt-3">
                                    ...
                                    @foreach ($thongSos as $thong_so)
                                        <div class="mb-3">
                                            <label class="form-label">{{ $thong_so->ten }}</label>

                                            @php
                                                $giaTri = $san_pham->thongSos->where('id', $thong_so->id)->first()
                                                    ?->pivot->gia_tri;

                                            @endphp

                                            <input type="text" class="form-control" name="thong_so[{{ $thong_so->id }}]"
                    ...
                    <div class="col-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" class="form-check-input "
                                        {{ $san_pham->noi_bat == true ? 'checked' : '' }} name="sp_noi_bat"
                                        id="">
                                </div>
                                <div class="form-check form-switch">
                                    <label for="" class="form-check-lable">Hiển thị sản phẩm</label>
                                    <input type="checkbox" class="form-check-input"
                                        {{ $san_pham->trang_thai == 'hien' ? 'checked' : '' }} name="sp_hien_thi"
                                        id="">
                                </div>
                                <select name="loai_sp" class="form-control" id="">
                                    <option value="don" {{ $san_pham->loai == 'don' ? 'selected' : '' }}>Đơn
                                    </option>
                                    <option value="bien_the" {{ $san_pham->loai == 'bien_the' ? 'selected' : '' }}>Biến
                                        thể</option>
                                </select>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <img class="img-thumbnail" src="{{ '/storage/' . $san_pham->anh_chinh }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="card">
                        ...
                        <div class="card">
                            <div class="card-body row">
                                @if ($san_pham->anhSanPhams->isNotEmpty())
                                    @foreach ($san_pham->anhSanPhams as $anh_phu)
                                        <div class="col-6 mb-2 "><img class="img-thumbnail"
                                                src="{{ '/storage/' . $anh_phu->duong_dan }}" alt=""></div>
                                    @endforeach
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="card-body row">
                                <select name="danh_muc[]"
                                    ...
                                    @foreach ($danhMucs as $danhMuc)
                                        <option value="{{ $danhMuc->id }}" @selected(in_array($danhMuc->id, old('danh_muc', $san_pham->danhMucs->pluck('id')->toArray())))>
                                            {{ $danhMuc->ten }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="card-body row">
                                <select name="thuong_hieu_id" class="form-control">
                                    ...
                                    @foreach ($thuongHieus as $thuongHieu)
                                        <option value="{{ $thuongHieu->id }}" @selected(old('thuong_hieu_id', $san_pham->thuongHieu?->id) == $thuongHieu->id)>
                                            {{ $thuongHieu->ten }}
                                        </option>
                                    @endforeach
                                </select>
